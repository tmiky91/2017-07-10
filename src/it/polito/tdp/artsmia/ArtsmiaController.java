...
public class ArtsmiaController {
	...
	void doCalcolaComponenteConnessa(ActionEvent event) {
		...
		if(id!=null && !id.isEmpty()) {
			if(model.isDigit(id)) {
				txtResult.setText(model.getConnessione(Integer.parseInt(id))); 
			}else {
				showMessage("Errore: Inserisci un id di un'opera d'arte valido");
			}
		}else {
			showMessage("Errore: Inserisci un id di un'opera d'arte");
		}
	}
